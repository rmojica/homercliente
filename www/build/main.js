...
var ProductsListPage = /** @class */ (function () {
    ...
    ProductsListPage.prototype.searchProduct = function () {
        ...
        if (this.radius > 0 && this.miLatitude.toString() != '' && this.miLongitude.toString() != '') {
            var midata = this.service.getLocationFromProduct2(this.lat, this.long, this.radius)
