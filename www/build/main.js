...
var Service = /** @class */ (function () {
    ...
    Service.prototype.getLocationFromProduct2 = function (lat, long, radius) {
        var _this = this;
        ...
        return new Promise(function (resolve) {
            ...
            _this.http
                ...
                if (_this.dataSearchProduct === undefined || _this.dataSearchProduct.length == 0) {
                    ...
                    for (var i = 0; i < _this.dataSearchProduct.length; i++) {
                        var product = _this.dataSearchProduct[i];
                        _this.values.homerOneSignal.push({ product: product.ui, providerOneSignal: _this.dataSearchProduct[i].onesignal });
                        _this.includeProduct += product.ui + ',';
                    }
    ...
    ProductPage.prototype.addToCart = function () {
        ...
        var resource_id = !this.selectedService
            ...
            : this.selectedService.resource_id
                ...
                : null;
        this.getAddressFromCoords();
        var date = __WEBPACK_IMPORTED_MODULE_6_moment___default()(this.selectedTime);
        var year = date.year();
