...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__products_products__ = __webpack_require__(99);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__search_search__ = __webpack_require__(188);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__product_product__ = __webpack_require__(53);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__post_post__ = __webpack_require__(79);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_geolocation_ngx__ = __webpack_require__(189);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ionic_native_native_geocoder__ = __webpack_require__(190);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__tabs_tabs__ = __webpack_require__(59);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__ionic_native_native_storage__ = __webpack_require__(94);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__ionic_native_onesignal__ = __webpack_require__(52);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ProductsListPage = /** @class */ (function () {
    function ProductsListPage(oneSignal, nativeStorage, alert, modalCtrl, platform, geolocation, nativeGeocoder, zone, toastCtrl, nav, service, values, loadingCtrl) {
        var _this = this;
    ...
    ProductsListPage.prototype.filterItems = function (searchTerm) {
    ...
    ProductsListPage.prototype.searchProduct = function () {
        ...
        this.oneSignal.getPermissionSubscriptionState().then(function (status) { return __awaiter(_this, void 0, void 0, function () {
            var _this = this;
            var alert_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(status.permissionStatus.state == 2 || status.permissionStatus.status == 1)) return [3 /*break*/, 2];
    ...
    ProductsListPage.prototype.presentLoading = function () {
...
var ModalContentPage = /** @class */ (function () {
    function ModalContentPage(platform, params, viewCtrl, values) {
        ...
        this.detail = this.detail.filter(function (result) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__forgotten_forgotten__ = __webpack_require__(402);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_onesignal__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__tabs_tabs__ = __webpack_require__(59);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AccountLogin = /** @class */ (function () {
    ...
    AccountLogin.prototype.showAlert = function (message) {
        var alert = this.alert.create({
            title: 'Atención',
            message: message,
            buttons: ['OK']
...
var CartService = /** @class */ (function () {
    ...
    CartService.prototype.loadCart = function () {
        ...
        return new Promise(function (resolve) {
            _this.http
                .get(_this.config.url + "/wp-admin/admin-ajax.php?action=mstoreapp-cart&userId=" + _this.values.customerId, _this.config.options)
                .map(function (res) { return res.json(); })
                .subscribe(function (data) {
                _this.cart = data;
                _this.values.cartNonce = data.cart_nonce;
    ...
    CartService.prototype.verifyOrderIsAvailableForPay = function (bookingid) {
        var _this = this;
        this.header.append('Content-Type', 'application/json');
        return new Promise(function (resolve) {
            _this.http
    ...
    CartService.prototype.checkout = function () {
        ...
        return new Promise(function (resolve) {
            _this.http
                .get(_this.config.url + "/wp-admin/admin-ajax.php?action=mstoreapp-get_checkout_form&userId=" + _this.values.customerId, _this.config.options)
                .map(function (res) { return res.json(); })
                .subscribe(function (data) {
                _this.billing = data;
                _this.http
                    .get(_this.config.url + "/wp-admin/admin-ajax.php?action=mstoreapp-update_order_review&userId=" + _this.values.customerId, _this.config.options)
                    .map(function (res) { return res.json(); })
                    .subscribe(function (data) {
                    resolve(data);
                });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__values__ = __webpack_require__(7);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CheckoutService = /** @class */ (function () {
    function CheckoutService(http, config, values) {
        this.http = http;
        this.config = config;
        this.values = values;
        this.header = new Headers();
    ...
    CheckoutService.prototype.updateOrderReview = function (form) {
        ...
        return new Promise(function (resolve) {
            _this.http.post(_this.config.url + "/wp-admin/admin-ajax.php?action=mstoreapp-update_order_review&userId=" + _this.values.customerId, params, _this.config.options).map(function (res) { return res.json(); })
                .subscribe(function (data) {
                _this.status = data;
                resolve(_this.status);
            });
    ...
    CheckoutService.prototype.checkout = function (form) {
        ...
        return new Promise(function (resolve) {
            _this.http.post(_this.config.url + '/checkout?wc-ajax=checkout&userId=' + _this.values.customerId, params, _this.config.options).map(function (res) { return res.json(); })
                .subscribe(function (data) {
                _this.status = data;
                resolve(_this.status);
            });
    ...
    CheckoutService.prototype.completeService = function (order) {
        var _this = this;
        return new Promise(function (resolve) {
            _this.http.post(_this.config.url + '/wp-admin/admin-ajax.php?action=mstoreapp-process_complete', { bookingid: order }, _this.config.options).map(function (res) { return res.json(); })
                .subscribe(function (data) {
                resolve(data);
            });
        });
    ...
    CheckoutService = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_http__["b" /* Http */], __WEBPACK_IMPORTED_MODULE_2__config__["a" /* Config */], __WEBPACK_IMPORTED_MODULE_6__values__["a" /* Values */]])
    ], CheckoutService);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__config__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__values__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_native_storage__ = __webpack_require__(94);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_http__ = __webpack_require__(95);
...
var Service = /** @class */ (function () {
    ...
    Service.prototype.getCategories = function (page) {
        var _this = this;
        this.http
            .get(this.config.setUrl('GET', '/wp-json/wc/v2/products/categories?order=asc&orderby=id&', {
            per_page: 100,
            page: page,
        }))
            .map(function (res) { return res.json(); })
        ...
        return new Promise(function (resolve) {
            _this.http
                ...
                if (data.statusText == "OK")
                    _this.functions.showAlert("ÉXITO", "Revisa tu correo te hemos enviado un nuevo link de verificación.");
                else
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_service_checkout_service__ = __webpack_require__(177);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_service_functions__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_service_values__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__products_list_products_list__ = __webpack_require__(110);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var OrderSummary = /** @class */ (function () {
    ...
    OrderSummary.prototype.ionViewDidLoad = function () {
        var _this = this;
        this.service.getOrderSummary(this.id).then(function (results) {
        ...
        this.service.completeService(this.id).then(function (results) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_service_values__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__cart_cart__ = __webpack_require__(58);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__product_product__ = __webpack_require__(53);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_service_category_service__ = __webpack_require__(100);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_service_wishlist_service__ = __webpack_require__(403);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_service_values__ = __webpack_require__(7);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__edit_address_form_edit_address_form__ = __webpack_require__(193);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AccountPage = /** @class */ (function () {
    ...
    AccountPage.prototype.gohomep = function () {
    ...
    AccountPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({template:/*ion-inline-start:"D:\desktop\numu\homer\homer\src\pages\account\account\account.html"*/'<!-- Header -->\n<ion-header>\n  <ion-toolbar color="header">\n    <ion-buttons slot="start">\n      <button ion-button icon-only (click)="gohomep()">\n        <ion-icon name="arrow-back"></ion-icon>\n      </button>\n    </ion-buttons>\n    <ion-title>\n      <img (click)="gohomep();" src="{{values.avatar}}" />\n    </ion-title>\n    <!-- <ion-buttons end>\n      <button ion-button icon-only light class="has-icon icon-only has-badge" (click)="getCart()">\n        <ion-icon class="ion-ios-cart item-icon"></ion-icon>\n        <ion-badge class="badge badge-light" *ngIf="values.count">\n          {{values.count}}\n        </ion-badge>\n      </button>\n    </ion-buttons> -->\n  </ion-toolbar>\n</ion-header>\n\n<ion-content fullscreen="true" slot="fixed">\n\n  <ion-spinner *ngIf="!customers" name="crescent"\n    style="display:block; margin-left: auto; margin-right:auto; margin-top: 5px;\n    margin-bottom:5px"></ion-spinner>\n\n  <div *ngIf="customers" class="customer">\n    <div *ngIf="customers.customer.billing_address">\n      <div class="card">\n        <div class="header">\n          <div class="avatar" *ngIf="checkAvatar()==\'false\'">\n            <img src="../../../assets/image/avatar40x40.png" alt="">\n          </div>\n          <div class="avatar" *ngIf="checkAvatar()!=\'false\'">\n            <img src="{{customers.customer.avatar_url}}" />\n          </div>\n        </div>\n        <div class="card-body">\n          <div class="user-meta ion-text-center">\n            <h3 class="playername">\n              {{customers.customer.billing_address.first_name}}\n              {{customers.customer.billing_address.last_name}}<br\n                *ngIf="customers.customer.billing_address.first_name">\n            </h3>\n            <h5 class="country">Cliente</h5>\n            <!-- <h5 class="country">{{customers.customer.role}}</h5> -->\n\n          </div>\n        </div>\n      </div>\n\n      <ion-card>\n        <ion-card-header>\n          {{"Home Address" | translate}}\n        </ion-card-header>\n        <ion-card-content style="margin-top: 10px">\n          <img width="40" src="../../../assets/image/home-icon.png" alt="">\n          <div>\n            <h5>{{customers.customer.billing_address.first_name}}\n              {{customers.customer.billing_address.last_name}}<br\n                *ngIf="customers.customer.billing_address.first_name"></h5>\n            <p>{{customers.customer.billing_address.address_1}}<br\n                *ngIf="customers.customer.billing_address.address_1">\n              {{customers.customer.billing_address.address_2}}<br\n                *ngIf="customers.customer.billing_address.address_2">\n              {{customers.customer.billing_address.city}}\n              {{customers.customer.billing_address.state}}<br\n                *ngIf="customers.customer.billing_address.city">\n              {{customers.customer.billing_address.phone}}<br\n                *ngIf="customers.customer.billing_address.phone">\n              {{customers.customer.billing_address.email}}<br\n                *ngIf="customers.customer.billing_address.email">\n              {{customers.customer.billing_address.country}}\n              {{customers.customer.billing_address.postcode}}<br\n                *ngIf="customers.customer.billing_address.postcode"></p>\n          </div>\n        </ion-card-content>\n      </ion-card>\n\n      <div *ngIf="customers.customer.shipping_address">\n        <ion-card style="margin-bottom: 20px;">\n          <ion-card-header>\n            {{"BillingAddress" | translate}}\n          </ion-card-header>\n          <ion-card-content style="margin-top: 10px">\n            <img src="../../../assets/image/home-address.png" alt="">\n            <div>\n              <h5>{{customers.customer.shipping_address.first_name}}\n                {{customers.customer.shipping_address.last_name}}<br\n                  *ngIf="customers.customer.shipping_address.first_name"></h5>\n              <p>{{customers.customer.shipping_address.address_1}}<br\n                  *ngIf="customers.customer.shipping_address.address_1">\n                {{customers.customer.shipping_address.address_2}}<br\n                  *ngIf="customers.customer.shipping_address.address_2">\n                {{customers.customer.shipping_address.city}}\n                {{customers.customer.shipping_address.state}}<br\n                  *ngIf="customers.customer.shipping_address.city">\n                {{customers.customer.shipping_address.phone}}<br\n                  *ngIf="customers.customer.shipping_address.phone">\n                {{customers.customer.shipping_address.email}}<br\n                  *ngIf="customers.customer.shipping_address.email">\n                {{customers.customer.shipping_address.country}}\n                {{customers.customer.shipping_address.postcode}}<br></p>\n            </div>\n          </ion-card-content>\n        </ion-card>\n      </div>\n      <div class="button-margin">\n        <button ion-button block color="button-color" type="submit"\n          class="button button-block button-default" text-uppercase\n          (click)="editAddress()">{{"EditAddress" | translate}}</button>\n      </div>\n    </div>\n  </div>\n</ion-content>\n'/*ion-inline-end:"D:\desktop\numu\homer\homer\src\pages\account\account\account.html"*/,
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ngx_socket_io__ = __webpack_require__(195);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_service_product_service__ = __webpack_require__(174);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__cart_cart__ = __webpack_require__(58);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_rxjs__ = __webpack_require__(101);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_rxjs___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_rxjs__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__chat_chat__ = __webpack_require__(201);
...
var OrdersPage = /** @class */ (function () {
    function OrdersPage(functions, nav, socket, navCtrl, navParams, values, productService, modalCtrl, loadingCtrl) {
        this.functions = functions;
        this.nav = nav;
        this.socket = socket;
    ...
    OrdersPage.prototype.changestatecancel = function (order, onesignal) {
        ...
        modal.onDidDismiss(function (data) {
            if (data.result && data.message != '') {
                ...
                _this.functions.showAlert("Éxito", "El servicio se ha cancelado correctamente, motivo " + data.message);
            }
        });
    };
    ...
    OrdersPage.prototype.openchat = function (order) {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_7__chat_chat__["a" /* ChatPage */], { order: order });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_ngx_socket_io__ = __webpack_require__(195);
...
var ChatPage = /** @class */ (function () {
    function ChatPage(socket, toastCtrl, alertCtrl, formBuilder, values, navParams, service, navCtrl) {
        this.socket = socket;
        this.toastCtrl = toastCtrl;
    ...
    ChatPage.prototype.goHome = function () {
        this.navCtrl.pop();
    };
    __decorate([
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_http__ = __webpack_require__(95);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ngx_translate_core__ = __webpack_require__(96);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_native_in_app_browser__ = __webpack_require__(176);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_service_checkout_service__ = __webpack_require__(177);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_service_functions__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_service_values__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__order_summary_order_summary__ = __webpack_require__(187);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__terms_condition_terms_condition__ = __webpack_require__(404);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_onesignal__ = __webpack_require__(52);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
        ...
        if (results.result == 'success') {
            ...
            browser_1.on('loadstart').subscribe(function (data) {
                if (data.url.indexOf('order-received') != -1) {
                    ...
                    _this.service.getOrderSummary(substr3[0]).then(function (results) {
                        results.order.booking_id.map(function (booking) {
                            _this.service.changestate({
                                "order": booking,
                                "state": "cancelado",
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__product_product__ = __webpack_require__(53);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__post_post__ = __webpack_require__(79);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_service_category_service__ = __webpack_require__(100);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_service_service__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_service_functions__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__products_list_products_list__ = __webpack_require__(110);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_service_values__ = __webpack_require__(7);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var AccountForgotten = /** @class */ (function () {
    ...
    AccountForgotten.prototype.goHome = function () {
        this.nav.setRoot(__WEBPACK_IMPORTED_MODULE_4__products_list_products_list__["b" /* ProductsListPage */]);
    };
    AccountForgotten = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavController"], __WEBPACK_IMPORTED_MODULE_2__providers_service_service__["a" /* Service */], __WEBPACK_IMPORTED_MODULE_3__providers_service_functions__["a" /* Functions */], __WEBPACK_IMPORTED_MODULE_5__providers_service_values__["a" /* Values */]])
    ], AccountForgotten);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_service_values__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_service_functions__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__md5__ = __webpack_require__(614);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__cart_cart__ = __webpack_require__(58);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__ionic_native_geolocation_ngx__ = __webpack_require__(189);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__ionic_native_native_geocoder__ = __webpack_require__(190);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__providers_service_service__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__providers_service_cart_service__ = __webpack_require__(175);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__orders_orders__ = __webpack_require__(194);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ProductPage = /** @class */ (function () {
    function ProductPage(alert, translate, nav, service, servi, otherservice, params, functions, values, platform, geolocation, nativeGeocoder, cartservice, oneSignal, loadingCtrl) {
        var _this = this;
        this.alert = alert;
        this.translate = translate;
        this.nav = nav;
        ...
        if (params.data.id) {
            ...
            this.date = __WEBPACK_IMPORTED_MODULE_7_moment___default()(params.data.date).format('DD-MM-YYYY');
        ...
        this.servi.getHomerOneSignal(this.product.product.id).then(function (result) {
            if (result.providers.length > 0) {
                _this.providerOneSignal = result.providers[0].onesignal;
            }
        });
    ...
    ProductPage.prototype.handleProductResults = function (results) {
        ...
        this.id = results.id;
        this.options.product_id = this.id;
        this.usedVariationAttributes = this.product.product.resources_full.map(function (item) { return item; });
        console.log('usedVariationAttributes:', this.usedVariationAttributes);
        this.loadDataProduct();
    ...
    ProductPage.prototype.presentLoading = function () {
        var loader = this.loadingCtrl.create({
            content: "Por favor espera...",
            duration: 3000
        });
    ...
    ProductPage.prototype.addToCart = function () {
        ...
        var resource_id = !this.selectedService
            ...
            : this.selectedService.resource_id
                ...
                : null;
        //this.getAddressFromCoords();
        var date = __WEBPACK_IMPORTED_MODULE_7_moment___default()(this.date);
        console.log(this.date);
        var year = date.year();
        ...
        this.service.
            ...
            if (results.status === "200") {
                if (results.booking_id_latest != false) {
                    ...
                    _this.service.addOrders({
                        ...
                        if (result.status == true) {
                            _this.service.sendNotification({
                                ...
                                "content": "Has recibido una solicitud de servicio de " + _this.values.customerName,
                    ...
                    _this.showAlert('No se encuentra disponible', "<strong>Ups!:</strong> Alparecer su Homer no se encuentra disponible, intentelo nuevamente");
                }
            }
            else {
    ...
    ProductPage.prototype.returnHome = function () {
        this.nav.push(__WEBPACK_IMPORTED_MODULE_14__orders_orders__["a" /* OrdersPage */]);
    };
    ...
    ProductPage.prototype.getReviews = function () {
        var _this = this;
        this.service.getReviews(this.id.id).then(function (results) { return _this.handleReview(results); });
    };
    ...
    ProductPage = ProductPage_1 = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["AlertController"],
            ...
            __WEBPACK_IMPORTED_MODULE_12__providers_service_service__["a" /* Service */],
            __WEBPACK_IMPORTED_MODULE_12__providers_service_service__["a" /* Service */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavParams"],
            __WEBPACK_IMPORTED_MODULE_4__providers_service_functions__["a" /* Functions */],
            __WEBPACK_IMPORTED_MODULE_3__providers_service_values__["a" /* Values */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["Platform"],
            __WEBPACK_IMPORTED_MODULE_10__ionic_native_geolocation_ngx__["a" /* Geolocation */],
            __WEBPACK_IMPORTED_MODULE_11__ionic_native_native_geocoder__["a" /* NativeGeocoder */],
            __WEBPACK_IMPORTED_MODULE_13__providers_service_cart_service__["a" /* CartService */],
...
var ModalPage = /** @class */ (function () {
    ...
    ModalPage.prototype.closeOther = function () {
        this.showItem = false;
    };
    ...
    ModalPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-modal',template:/*ion-inline-start:"D:\desktop\numu\homer\homer\src\pages\modal\modal.html"*/'<!--\n  Generated template for the OrdersPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header class="settings-header">\n  <ion-navbar color="header">\n    <ion-buttons left>\n      <button ion-button icon-left (click)="cancel()">\n        <ion-icon name="arrow-back"></ion-icon>\n      </button>\n    </ion-buttons>\n    <!-- <ion-title text-wrap text-center *ngIf="post?.post_title">{{post.post_title}} </ion-title> -->\n    <ion-title>\n      cancelar servicio\n      <!-- <img  (click)="gohome();" style="max-width: 150px;" src="{{values.avatar}}" /> -->\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n<ion-content style="width: 100%;">\n  <div class="sub-header">\n    <h1>Motivos de Cancelación</h1>\n  </div>\n  <ion-list radio-group (ionChange)="selectMessage($event)" style="margin: 100px\n    auto 10px ; width: 90%;">\n    <!-- <ion-list-header>\n          <ion-label>\n            Seleccione por favor una de las opciones\n          </ion-label>\n      </ion-list-header> -->\n    <ion-item no-lines style="margin-top:50px; border-radius: 5px;"\n      class="card2">\n      <ion-label class="heading text-center" style="font-size:1em;\n        font-weight: 900;">\n        He contratado el servicio por  equivo- <br> cación.\n      </ion-label>\n      <ion-radio item-center color="dark" value="He contratado el servicio por\n        equivocación." (click)="closeOther()"></ion-radio>\n    </ion-item>\n\n    <ion-item no-lines style="margin-top:10px; border-radius: 5px;"\n      class="card2">\n      <ion-label class="heading text-center" style="font-size: 1em;\n        font-weight: 900;">\n        He seleccionado al HOMER equivocado.\n      </ion-label>\n      <ion-radio item-center color="dark" value="He seleccionado al HOMER\n        equivocado." (click)="closeOther()"></ion-radio>\n    </ion-item>\n\n    <ion-item no-lines style="margin-top:10px; border-radius: 5px;"\n      class="card2">\n      <ion-label class="heading text-center" style="font-size: 1em;\n        font-weight: 900;">\n        Otros\n      </ion-label>\n      <ion-radio item-center color="dark" value="Otros" (click)="showOther()"></ion-radio>\n    </ion-item>\n    <ion-item no-lines style="margin-top:10px; border-radius: 5px;"\n      class="card2" [hidden]="!showItem">\n      <textarea id="otro" name="otro" rows="4" cols="10">\n\n      </textarea>\n    </ion-item>\n  </ion-list>\n  <div style="width:100%;">\n    <div style="margin:0 auto; width: 70%; display:flex; justify-content:\n      space-between;">\n      <button ion-button style="font-family: \'Courier New\', Courier, monospace;"\n        (click)="acept()">Aceptar</button>\n      <button class="black" ion-button style="font-family: \'Courier New\',\n        Courier, monospace;" (click)="cancel()">Cancelar</button>\n    </div>\n\n  </div>\n</ion-content>\n'/*ion-inline-end:"D:\desktop\numu\homer\homer\src\pages\modal\modal.html"*/,
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_service_service__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_service_values__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__edit_address_form_edit_address_form__ = __webpack_require__(193);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_observable_defer__ = __webpack_require__(309);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_rxjs_operators__ = __webpack_require__(399);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_service_values__ = __webpack_require__(7);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_native_email_composer__ = __webpack_require__(202);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_service_values__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_post_post__ = __webpack_require__(79);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var PagesSupportPage = /** @class */ (function () {
    ...
    PagesSupportPage.prototype.post = function (id, title) {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_4__pages_post_post__["a" /* Post */], { id: id, title: title });
    };
    ...
    PagesSupportPage.prototype.goHome = function () {
        this.navCtrl.pop();
    };
    PagesSupportPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-pages-support',template:/*ion-inline-start:"D:\desktop\numu\homer\homer\src\pages\pages-support\pages-support.html"*/'<ion-header style="background-color: #72A9AE;">\n  <ion-toolbar color="header">\n    <ion-buttons slot="start">\n      <button ion-button icon-only (click)="goHome()">\n        <ion-icon name="arrow-back"></ion-icon>\n      </button>\n    </ion-buttons>\n    <ion-title class="logo-title">\n      <div>\n        <img width="200" src="{{values.avatar}}" />\n      </div>\n    </ion-title>\n  </ion-toolbar>\n</ion-header>\n<ion-content class="page-pages-support" padding [content]="content">\n  <div class="sub-header">\n    <h1>Soporte</h1>\n  </div>\n  <!-- <ion-card style="margin-top: 100px;">\n    <ion-card-content *ngIf="post">\n\n    </ion-card-content>\n  </ion-card> -->\n  <ion-list  *ngIf="post" no-lines>\n      <ion-item tappable menuClose *ngIf="values.data?.pages?.about && values.data?.pages?.about != \'0\'"\n        (click)="post(values.data?.pages?.about,\'Acerca de Nosotros\')"  class="bg-green">\n        {{"About Us" | translate}}\n        <ion-icon name="ios-information-circle" item-left></ion-icon>\n      </ion-item>\n\n\n      <ion-item tappable menuClose *ngIf="values.data?.pages?.about && values.data?.pages?.privacy != \'0\'"\n        (click)="post(values.data?.pages?.privacy, \'Política de Privacidad\')" class="bg-green">\n        {{"Política de privacidad" | translate}}\n        <ion-icon name="ios-lock" item-left></ion-icon>\n      </ion-item>\n\n\n      <ion-item tappable menuClose *ngIf="values.data?.pages?.about && values.data?.pages?.terms != \'0\'"\n        (click)="post(values.data?.pages?.terms, \'Términos y Condiciones\')"  class="bg-green">\n        {{"Términos & Condiciones" | translate}}\n        <ion-icon name="ios-bookmarks" item-left></ion-icon>\n      </ion-item>\n\n      <ion-item tappable menuClose (click)="contact()">\n        {{"Contacta con nosotros" | translate}}\n        <ion-icon name="ios-mail" item-left></ion-icon>\n      </ion-item>\n\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"D:\desktop\numu\homer\homer\src\pages\pages-support\pages-support.html"*/,
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__app_component__ = __webpack_require__(607);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pages_home_home__ = __webpack_require__(401);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_account_address_address__ = __webpack_require__(552);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pages_account_edit_address_form_edit_address_form__ = __webpack_require__(193);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages_account_forgotten_forgotten__ = __webpack_require__(402);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pages_account_login_login__ = __webpack_require__(111);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_post_post__ = __webpack_require__(79);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_account_order_details_order_details__ = __webpack_require__(203);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_account_orders_orders__ = __webpack_require__(912);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pages_orders_orders__ = __webpack_require__(194);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__pages_account_register_register__ = __webpack_require__(553);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__pages_account_wishlist_wishlist__ = __webpack_require__(191);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__pages_account_account_account__ = __webpack_require__(192);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__pages_cart_cart__ = __webpack_require__(58);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__pages_checkout_billing_address_form_billing_address_form__ = __webpack_require__(306);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__pages_checkout_order_summary_order_summary__ = __webpack_require__(187);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__pages_checkout_terms_condition_terms_condition__ = __webpack_require__(404);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__pages_product_product__ = __webpack_require__(53);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__pages_products_products__ = __webpack_require__(99);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__pages_search_search__ = __webpack_require__(188);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__pages_tabs_tabs__ = __webpack_require__(59);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__pages_products_list_products_list__ = __webpack_require__(110);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__pages_chat_chat__ = __webpack_require__(201);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__pages_pages_support_pages_support__ = __webpack_require__(560);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_32__ionic_native_status_bar__ = __webpack_require__(301);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33__ionic_native_splash_screen__ = __webpack_require__(305);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_34__ionic_native_native_storage__ = __webpack_require__(94);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_35__angular_platform_browser__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_36__providers_service_cart_service__ = __webpack_require__(175);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_37__providers_service_wishlist_service__ = __webpack_require__(403);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_38__providers_service_category_service__ = __webpack_require__(100);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_39__providers_service_checkout_service__ = __webpack_require__(177);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_40__providers_service_config__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_41__providers_service_functions__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_42__providers_service_product_service__ = __webpack_require__(174);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_43__providers_service_search_service__ = __webpack_require__(400);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_44__providers_service_service__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_45__providers_service_values__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_46__providers_pipe_pipe__ = __webpack_require__(913);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_47__pipes_safe_html_safe_html__ = __webpack_require__(914);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_48__pipes_duration_duration__ = __webpack_require__(915);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_49__ionic_native_call_number__ = __webpack_require__(916);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_50__ionic_native_email_composer__ = __webpack_require__(202);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_51__ionic_native_app_rate__ = __webpack_require__(554);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_52__ionic_native_social_sharing__ = __webpack_require__(555);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_53__angular_common_http__ = __webpack_require__(917);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_54__angular_http__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_55__ngx_translate_core__ = __webpack_require__(96);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_56__ngx_translate_http_loader__ = __webpack_require__(918);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_57__ionic_native_onesignal__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_58__ionic_native_http__ = __webpack_require__(95);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_59_ion2_calendar__ = __webpack_require__(920);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_59_ion2_calendar___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_59_ion2_calendar__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_60__ionic_native_geolocation_ngx__ = __webpack_require__(189);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_61__ionic_native_native_geocoder__ = __webpack_require__(190);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_62__ionic_native_in_app_browser__ = __webpack_require__(176);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_63__angular_forms__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_64_angular_cc_library__ = __webpack_require__(559);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_65_ngx_socket_io__ = __webpack_require__(195);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_66__angular_common_locales_es__ = __webpack_require__(924);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_67__angular_common__ = __webpack_require__(55);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
Object(__WEBPACK_IMPORTED_MODULE_67__angular_common__["i" /* registerLocaleData */])(__WEBPACK_IMPORTED_MODULE_66__angular_common_locales_es__["a" /* default */]);
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_46__providers_pipe_pipe__["a" /* KeysPipe */],
                ...
                __WEBPACK_IMPORTED_MODULE_47__pipes_safe_html_safe_html__["a" /* SafeHtmlPipe */],
                __WEBPACK_IMPORTED_MODULE_48__pipes_duration_duration__["a" /* DurationPipe */]
            ],
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_59_ion2_calendar__["CalendarModule"],
                __WEBPACK_IMPORTED_MODULE_63__angular_forms__["ReactiveFormsModule"],
                __WEBPACK_IMPORTED_MODULE_64_angular_cc_library__["b" /* CreditCardDirectivesModule */],
                __WEBPACK_IMPORTED_MODULE_54__angular_http__["c" /* HttpModule */],
                __WEBPACK_IMPORTED_MODULE_65_ngx_socket_io__["b" /* SocketIoModule */].forRoot(config),
            ...
            providers: [
                __WEBPACK_IMPORTED_MODULE_36__providers_service_cart_service__["a" /* CartService */],
                __WEBPACK_IMPORTED_MODULE_37__providers_service_wishlist_service__["a" /* WishlistService */],
                __WEBPACK_IMPORTED_MODULE_38__providers_service_category_service__["a" /* CategoryService */],
                __WEBPACK_IMPORTED_MODULE_39__providers_service_checkout_service__["a" /* CheckoutService */],
                __WEBPACK_IMPORTED_MODULE_40__providers_service_config__["a" /* Config */],
                __WEBPACK_IMPORTED_MODULE_41__providers_service_functions__["a" /* Functions */],
                __WEBPACK_IMPORTED_MODULE_42__providers_service_product_service__["a" /* ProductService */],
                __WEBPACK_IMPORTED_MODULE_43__providers_service_search_service__["a" /* SearchService */],
                __WEBPACK_IMPORTED_MODULE_44__providers_service_service__["a" /* Service */],
                __WEBPACK_IMPORTED_MODULE_45__providers_service_values__["a" /* Values */],
                ...
                __WEBPACK_IMPORTED_MODULE_62__ionic_native_in_app_browser__["a" /* InAppBrowser */],
                ...
                __WEBPACK_IMPORTED_MODULE_51__ionic_native_app_rate__["a" /* AppRate */],
                ...
                __WEBPACK_IMPORTED_MODULE_58__ionic_native_http__["a" /* HTTP */],
                __WEBPACK_IMPORTED_MODULE_60__ionic_native_geolocation_ngx__["a" /* Geolocation */],
                ...
                { provide: __WEBPACK_IMPORTED_MODULE_0__angular_core__["LOCALE_ID"], useValue: 'es-ES' }
            ],
            schemas: [
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_service_cart_service__ = __webpack_require__(175);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_service_values__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_service_functions__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__checkout_billing_address_form_billing_address_form__ = __webpack_require__(306);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__tabs_tabs__ = __webpack_require__(59);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var CartPage = /** @class */ (function () {
    function CartPage(loadingCtrl, nav, service, values, params, functions, alert) {
        this.loadingCtrl = loadingCtrl;
        this.nav = nav;
        this.service = service;
        this.values = values;
    ...
    CartPage.prototype.handleCartInit = function (results) {
        ...
        Object.keys(results.cart_contents).map(function (key) {
            _this.bookingid.push(results.cart_contents[key].booking._booking_id);
        });
    ...
    CartPage.prototype.delete = function (key, bookingid) {
        var _this = this;
        this.bookingid.map(function (booking) {
            _this.service.verifyOrderIsAvailableForDelete(booking).then(function (result) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        _a.label = 1;
                    case 1:
                        if (!(i < this.bookingid)) return [3 /*break*/, 4];
                        console.log(this.bookingid[i]);
                        if (!(this.bookingid[i] != undefined)) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.service.verifyOrderIsAvailableForPay(this.bookingid[i])];
                    case 2:
                        result = _a.sent();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__home_home__ = __webpack_require__(401);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__account_login_login__ = __webpack_require__(111);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__products_list_products_list__ = __webpack_require__(110);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_account_wishlist_wishlist__ = __webpack_require__(191);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__cart_cart__ = __webpack_require__(58);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_service_values__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pages_account_account_account__ = __webpack_require__(192);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_service_values__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_service_config__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ngx_translate_core__ = __webpack_require__(96);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_onesignal__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_products_products__ = __webpack_require__(99);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_cart_cart__ = __webpack_require__(58);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pages_account_login_login__ = __webpack_require__(111);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__pages_account_address_address__ = __webpack_require__(552);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__pages_orders_orders__ = __webpack_require__(194);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__pages_account_register_register__ = __webpack_require__(553);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__pages_checkout_order_summary_order_summary__ = __webpack_require__(187);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__pages_account_wishlist_wishlist__ = __webpack_require__(191);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__pages_product_product__ = __webpack_require__(53);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__pages_post_post__ = __webpack_require__(79);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__ionic_native_app_rate__ = __webpack_require__(554);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__ionic_native_social_sharing__ = __webpack_require__(555);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__ionic_native_email_composer__ = __webpack_require__(202);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__ionic_native_native_storage__ = __webpack_require__(94);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__pages_account_account_account__ = __webpack_require__(192);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__ionic_native_in_app_browser__ = __webpack_require__(176);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__pages_tabs_tabs__ = __webpack_require__(59);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__pages_chat_chat__ = __webpack_require__(201);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__pages_pages_support_pages_support__ = __webpack_require__(560);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MyApp = /** @class */ (function () {
    ...
    MyApp.prototype.account = function () {
        this.nav.push(__WEBPACK_IMPORTED_MODULE_23__pages_account_account_account__["a" /* AccountPage */]);
    };
    ...
    MyApp.prototype.order = function () {
        this.nav.push(__WEBPACK_IMPORTED_MODULE_13__pages_orders_orders__["a" /* OrdersPage */]);
    };
    ...
    MyApp.prototype.support = function () {
        this.nav.push(__WEBPACK_IMPORTED_MODULE_30__pages_pages_support_pages_support__["a" /* PagesSupportPage */]);
    };
    MyApp.prototype.initializeApp = function () {
        var _this = this;
        this.platform.ready().then(function () {
            _this.checkNotificationPermission();
        });
        this.platform.resume.subscribe(function (result) {
            _this.checkNotificationPermissionState();
        });
    };
    MyApp.prototype.checkNotificationPermission = function () {
        var _this = this;
        this.nativeStorage.getItem('firstLaunch').then(function (value) {
            _this.firstLaunch = value;
            if (_this.firstLaunch) {
                console.log("firstLaunch1: ", _this.firstLaunch);
                _this.checkNotificationPermissionState();
            }
            else {
                console.log("firstLaunch7: ", "this.firstLaunch");
                //First time launch and update the flag
                _this.nativeStorage.setItem('firstLaunch', true).then(function () {
                    ...
                    if (_this.platform.is('ios')) {
                        ...
                        _this.oneSignal.addPermissionObserver().subscribe(function (data) { return __awaiter(_this, void 0, void 0, function () {
                            var alert_1;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        if (!(data.to.status == 1)) return [3 /*break*/, 2];
    ...
    MyApp.prototype.checkNotificationPermissionState = function () {
        var _this = this;
        this.oneSignal.getPermissionSubscriptionState().then(function (status) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                //iOS only: Integer: 0 = Not Determined, 1 = Denied, 2 = Authorized
...
var SafeHtmlPipe = /** @class */ (function () {
     ...
     */
    SafeHtmlPipe.prototype.transform = function (Unixdate) {
...
var DurationPipe = /** @class */ (function () {
     ...
     * Takes a value and makes it lowercase.
     */
    DurationPipe.prototype.transform = function (concat, hourInit, hourEnd) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_service_category_service__ = __webpack_require__(100);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_service_service__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_service_values__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_service_functions__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__product_product__ = __webpack_require__(53);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var ProductsPage = /** @class */ (function () {
    function ProductsPage(alert, nav, popoverCtrl, service, params, values, functions, services, loadingCtrl) {
        var _this = this;
        this.alert = alert;
        this.nav = nav;
    ...
    ProductsPage.prototype.getProduct = function (id) {
        ...
        this.presentLoading();
        if (this.values.isLoggedIn) {
            this.services.getHomerOneSignal(id.id).then(function (result) {
                if (result.providers.length > 0) {
                    _this.nav.push(__WEBPACK_IMPORTED_MODULE_6__product_product__["a" /* ProductPage */], { id: id, product_sl: _this.product_slot, date: _this.date, hourInit: _this.hourInit, hourEnd: _this.hourEnd });
                }
                else {
                    _this.showAlert('<strong>Estimado Usuario</strong><br/><br/>', 'El Homer que está seleccionando no está disponible en este momento.');
                }
            });
        }
        else {
    ...
    ProductsPage = ProductsPage_1 = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["AlertController"],
            ...
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavParams"],
            __WEBPACK_IMPORTED_MODULE_4__providers_service_values__["a" /* Values */],
            __WEBPACK_IMPORTED_MODULE_5__providers_service_functions__["a" /* Functions */],
            __WEBPACK_IMPORTED_MODULE_3__providers_service_service__["a" /* Service */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["LoadingController"]])
    ], ProductsPage);
    return ProductsPage;
