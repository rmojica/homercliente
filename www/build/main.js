...
var ProductsListPage = /** @class */ (function () {
    ...
    ProductsListPage.prototype.handleLocationInit = function (results) {
        ...
        this.nav.push(__WEBPACK_IMPORTED_MODULE_4__products_products__["a" /* ProductsPage */], { items: this.items.productslocation, categories: this.categories, date: this.date, hourInit: this.hourInit, hourEnd: this.hourEnd });
...
var ProductPage = /** @class */ (function () {
    function ProductPage(alert, translate, nav, service, params, functions, values, platform, geolocation, nativeGeocoder) {
        var _this = this;
        this.alert = alert;
        this.translate = translate;
        this.nav = nav;
...
var ProductsPage = /** @class */ (function () {
    ...
    ProductsPage.prototype.getProduct = function (id) {
        this.nav.push(__WEBPACK_IMPORTED_MODULE_5__product_product__["a" /* ProductPage */], { id: id, date: this.date, hourInit: this.hourInit, hourEnd: this.hourEnd });
    };
    // getCart() {
