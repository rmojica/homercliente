...
export class CartService {
  ...
  loadCart() {
    return new Promise(resolve => {
      this.http
        .get(`${this.config.url}/wp-admin/admin-ajax.php?action=mstoreapp-cart&userId=${this.values.customerId}`,
          this.config.options,
        )
        .map(res => res.json())
        .subscribe(data => {
  ...
  submitCoupon(coupon) {
    ...
    return new Promise(resolve => {
      this.http
        .post(
          this.config.url +
            '/wp-admin/admin-ajax.php?action=mstoreapp-apply_coupon',
          params,
          this.config.options,
        )
        .subscribe(data => {
  ...
  removeCoupon(coupon) {
    ...
    return new Promise(resolve => {
      this.http
        .post(
          this.config.url +
            '/wp-admin/admin-ajax.php?action=mstoreapp-remove_coupon',
          params,
          this.config.options,
        )
        .subscribe(data => {
  ...
  updateShipping(method) {
    ...
    return new Promise(resolve => {
      this.http
        .post(
          this.config.url +
            '/wp-admin/admin-ajax.php?action=mstoreapp-update_shipping_method',
          params,
          this.config.options,
        )
        .map(res => res.json())
